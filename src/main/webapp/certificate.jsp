...
<form action="controller" method="post">
	...
	<table border="1">
		<tr>
			...
			<!-- <input type="radio" name="sqld" value="0"><label>무</label> -->
			</td>
		</tr>
		<tr>
			<td>ADsP</td>
			...
			<!-- <input type="radio" name="adsp" value="0"><label>무</label> -->
			</td>
		</tr>
		<tr>
			<td>DAsP</td>
			...
			<!-- <input type="radio" name="dasp" value="0"><label>무</label> -->
			</td>
		</tr>
		<tr>
			<td>빅데이터분석기사</td>
			<td>
			<input type="radio" name="bad" value="25"><label>유</label>&nbsp;&nbsp;&nbsp;
			<!-- <input type="radio" name="bad" value="0"><label>무</label> -->
			</td>
		</tr>
		<tr>
			<td>정보처리기사</td>
			...
			<!-- <input type="radio" name="ipe" value="0"><label>무</label> -->
			</td>
		</tr>
...
<br><br><br>
<a href="index.jsp">메인 화면으로 이동하기</a>
</body>
</html>